    ...
    <div class="col-md-3">
        <form method="post" action="shop.php?action=add&id=<?php echo $row["id"]; ?>">
            <div style="border: 1px solid #eaeaec; margin: -1px 19px 3px -1px; box-shadow: 0 1px 2px rgba(0,0,0,0.05); padding:10px;"
                ...
                <input type="submit" name="add" style="margin-top:5px;" class="btn btn-default"
                       value="Add to Bag">
        ...
        <a class="btn btn-danger" style="margin-top:5px;"  href="delete_item.php?id=<?php echo $row['id']; ?>">Delete</a>
    </div>
</div>
<?php
}
